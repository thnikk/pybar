...
class VolumeSliderRow(Gtk.Box):
    ...
    Provides left-click drag to set volume, right-click to toggle mute,
    middle-click to set the device as default, and optional scroll-to-
    adjust. scroll_to_adjust defaults to False because rows are normally
    hosted inside scroll boxes.
    """
    ...
    def __init__(
        ...
        # Overlay places content over the progress bar background
        overlay = Gtk.Overlay()
        ...
        # Optional scroll-to-adjust; disabled by default in pybar since
        # rows live inside scroll boxes
        ...
        # Middle-click to set as default device (no-op without callback)
    ...
    def _update_ui(self):
        """Refresh the progress bar and CSS state."""
