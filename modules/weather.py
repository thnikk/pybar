...
def module(config={}):
    ...
    module = c.Module()
    module.icon.set_label(f"{om.weather.hourly.icon(hour_now, night)}")
    module.text.set_label(f"{om.weather.hourly.temp(hour_now)}°")

    module.set_widget('Weather')
